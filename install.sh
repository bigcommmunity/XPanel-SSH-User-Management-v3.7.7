...
if [ "$n" != "" ]; then
if [ "$n" == "1" ]; then
linkd=https://api.github.com/repos/bigcommmunity/XPanel-SSH-User-Management-v3.7.7/releases/tags/37
fi
if [ "$n" == "2" ]; then
linkd=https://api.github.com/repos/bigcommmunity/XPanel-SSH-User-Management-v3.7.7/releases/tags/xpanel
fi
else
linkd=https://api.github.com/repos/bigcommmunity/XPanel-SSH-User-Management-v3.7.7/releases/tags/xpanel
fi
